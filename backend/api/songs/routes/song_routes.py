...
# These MUST come before parameterized routes like /{song_id} to avoid routing conflicts
# =============================================================================
...
# =============================================================================
# AUTHENTICATED ENDPOINTS - Parameterized routes
# These come after static routes to prevent /{song_id} from matching paths like /recent-releases
# =============================================================================
