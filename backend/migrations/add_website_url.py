"""
Migration: Add website URL field to users

This migration:
1. Adds website_url column to users table
"""
...
def run_migration():
    """Add website_url field to users table"""
    ...
    try:
        print("Starting migration: Add website URL field to users...")
        ...
        if 'website_url' not in column_names:
            print("Adding website_url column to users table...")
            cursor.execute("ALTER TABLE users ADD COLUMN website_url TEXT")
