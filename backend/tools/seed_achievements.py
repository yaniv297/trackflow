...
ACHIEVEMENTS = [
    ...
    ("dreamer", "Dreamer", "Add your first song to Future Plans", "💭", "milestone", 10, "common", 1, "total_future"),
    ("visionary", "Visionary", "Add 5 songs to Future Plans", "🔮", "milestone", 10, "common", 5, "total_future"),
    ("long_term_planner", "Long Term Planner", "Add 10 songs to Future Plans", "📋", "milestone", 25, "uncommon", 10, "total_future"),
    ("strategic_thinker", "Strategic Thinker", "Add 25 songs to Future Plans", "🗺️", "milestone", 25, "uncommon", 25, "total_future"),
    ("master_planner", "Master Planner", "Add 50 songs to Future Plans", "📊", "milestone", 50, "rare", 50, "total_future"),
    ("future_architect", "Future Architect", "Add 100 songs to Future Plans", "🏗️", "milestone", 100, "epic", 100, "total_future"),
    ("planning_legend", "Planning Legend", "Add 250 songs to Future Plans", "📐", "milestone", 100, "epic", 250, "total_future"),
    
    # WIP Songs (Work/Progress)
    ("getting_started_wip", "Getting Started", "Start your first WIP song", "🎬", "milestone", 10, "common", 1, "total_wip"),
    ("hard_worker", "Hard Worker", "Start 5 WIP songs", "💪", "milestone", 10, "common", 5, "total_wip"),
    ("dedicated_creator", "Dedicated Creator", "Start 10 WIP songs", "🎨", "milestone", 25, "uncommon", 10, "total_wip"),
    ("busy_bee", "Busy Bee", "Start 25 WIP songs", "🐝", "milestone", 25, "uncommon", 25, "total_wip"),
    ("workhorse", "Workhorse", "Start 50 WIP songs", "🐴", "milestone", 50, "rare", 50, "total_wip"),
    ("productivity_master", "Productivity Master", "Start 100 WIP songs", "⚡", "milestone", 100, "epic", 100, "total_wip"),
    ("work_legend", "Work Legend", "Start 250 WIP songs", "🔨", "milestone", 100, "epic", 250, "total_wip"),
    
    # WIP Completions (Finishing Work)
    ("first_finish", "First Finish", "Complete your first WIP (move to Released)", "🎉", "milestone", 10, "common", 1, "wip_completions"),
    ("finisher", "Finisher", "Complete 5 WIP songs", "✅", "milestone", 10, "common", 5, "wip_completions"),
    ("wip_master", "WIP Master", "Complete 10 WIP songs", "🏁", "milestone", 25, "uncommon", 10, "wip_completions"),
    ("finishing_touch", "Finishing Touch", "Complete 25 WIP songs", "✨", "milestone", 50, "rare", 25, "wip_completions"),
    ("master_finisher", "Master Finisher", "Complete 50 WIP songs", "🎊", "milestone", 50, "rare", 50, "wip_completions"),
    ("completion_legend", "Completion Legend", "Complete 100 WIP songs", "🎆", "milestone", 100, "epic", 100, "wip_completions"),
    ("fireworks_master", "Fireworks Master", "Complete 250 WIP songs", "🎇", "milestone", 100, "epic", 250, "wip_completions"),
    
    # Released Songs (Celebration)
    ("first_release", "First Release", "Release your first song", "✨", "milestone", 10, "common", 1, "total_released"),
    ("rising_star", "Rising Star", "Release 5 songs", "⭐", "milestone", 10, "common", 5, "total_released"),
    ("published_artist", "Published Artist", "Release 10 songs", "🌟", "milestone", 25, "uncommon", 10, "total_released"),
    ("pro_performer", "Pro Performer", "Release 25 songs", "💫", "milestone", 50, "rare", 25, "total_released"),
    ("chart_topper", "Chart Topper", "Release 50 songs", "🏆", "milestone", 50, "rare", 50, "total_released"),
    ("hall_of_fame", "Hall of Fame", "Release 100 songs", "🎖️", "milestone", 100, "epic", 100, "total_released"),
    ("legendary_status", "Legendary Status", "Release 250 songs", "👑", "milestone", 250, "legendary", 250, "total_released"),
    
    # Packs
    ("pack_starter", "Pack Starter", "Create your first pack", "📦", "milestone", 10, "common", 1, "total_packs"),
    ("pack_creator", "Pack Creator", "Create 3 packs", "📚", "milestone", 25, "uncommon", 3, "total_packs"),
    ("pack_master", "Pack Master", "Create 5 packs", "📖", "milestone", 25, "uncommon", 5, "total_packs"),
    ("pack_legend", "Pack Legend", "Create 10 packs", "📘", "milestone", 50, "rare", 10, "total_packs"),
    ("pack_collector", "Pack Collector", "Create 20 packs", "📗", "milestone", 100, "epic", 20, "total_packs"),
    
    # Collaborations (as owner)
    ("first_collaborator", "Team Player", "Add your first collaborator", "🤝", "milestone", 10, "common", 1, "total_collaborations"),
    ("three_collaborations", "Collaborator", "Have 3 collaborations", "👥", "milestone", 25, "uncommon", 3, "total_collaborations"),
    ("ten_collaborations", "Social Butterfly", "Have 10 collaborations", "🦋", "milestone", 50, "rare", 10, "total_collaborations"),
    ("twenty_five_collaborations", "Community Leader", "Have 25 collaborations", "👑", "milestone", 100, "epic", 25, "total_collaborations"),
    ...
    ("hundred_different_years", "History Buff", "Complete songs from 100 different years", "📚", "diversity", 250, "legendary", 100, "unique_years"),
