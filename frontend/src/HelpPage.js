        ...
        >
          ...
          <section style={{ marginBottom: "2.5rem" }}>
            ...
            <p style={{ lineHeight: "1.6", color: "#333" }}>
              ...
              collaborate with other authors, and manage multiple songs and
              packs efficiently.
            </p>
          </section>
          ...
          <section style={{ marginBottom: "2.5rem" }}>
            ...
            <ul style={{ lineHeight: "1.8", color: "#555" }}>
              ...
              <li>
                <strong>Track Progress:</strong> Click checkboxes on the WIP
                page to mark steps as complete
              </li>
              <li>
              ...
              <li>
                <strong>Examples:</strong> Common steps include Tempo Map,
                Drums, Bass, Guitar, Vocals, Harmonies, Pro Keys, Venue,
                Animations, Compile
              </li>
            </ul>
          </section>
          ...
          <section style={{ marginBottom: "2.5rem" }}>
            ...
            <p style={{ lineHeight: "1.6", color: "#555" }}>
              Packs are collections of songs (e.g., an album, artist
              discography, or themed compilation).
            </p>
            <ul style={{ lineHeight: "1.8", color: "#555" }}>
              <li>
              ...
              <li>
                <strong>Pack Info:</strong> Set artist, album name, cover art,
                and release year
              </li>
              <li>
            ...
            <ul style={{ lineHeight: "1.8", color: "#555" }}>
              <li>
                <strong>Create Song:</strong> Click "New +" → "New Song" or add
                to an existing pack
              </li>
              <li>
                <strong>Song Status:</strong> Not Started, In Progress,
          ...
          <section style={{ marginBottom: "2.5rem" }}>
            ...
            <ul style={{ lineHeight: "1.8", color: "#555" }}>
              ...
              <li>
                <strong>Select User:</strong> Choose an existing user or create
                a new "unclaimed" account
              </li>
              <li>
          ...
          <section style={{ marginBottom: "2.5rem" }}>
            ...
            <ul style={{ lineHeight: "1.8", color: "#555" }}>
              ...
              <li>
                <strong>Progress Tracking:</strong> Click workflow step
                checkboxes to update progress
              </li>
              <li>
              ...
              <li>
                <strong>Quick Actions:</strong> Edit, delete, or view song
                details
              </li>
            </ul>
          </section>
          ...
          <section style={{ marginBottom: "2.5rem" }}>
            ...
            <p style={{ lineHeight: "1.6", color: "#555" }}>
              View analytics about your authoring progress, including total
              songs, completion rates, and workflow step statistics.
            </p>
          ...
          <section style={{ marginBottom: "2.5rem" }}>
            ...
            <div style={{ marginTop: "1.5rem" }}>
              ...
              <p
                style={{ lineHeight: "1.6", color: "#555", marginLeft: "1rem" }}
              >
                Go to Settings → Workflow. You can add new steps, remove
                existing ones, reorder them, and rename them. Changes apply
                immediately to all your in-progress songs.
              </p>
            </div>
            ...
            <div style={{ marginTop: "1.5rem" }}>
              ...
              <p
                style={{ lineHeight: "1.6", color: "#555", marginLeft: "1rem" }}
              >
                The new step is automatically added to all your in-progress
                songs. Already-completed songs will have the new step marked as
            ...
            <div style={{ marginTop: "1.5rem" }}>
              ...
              <p
                style={{ lineHeight: "1.6", color: "#555", marginLeft: "1rem" }}
              >
                Each user has their own custom workflow. When you collaborate on
                a song, you see your workflow steps, and your collaborator sees
            ...
            <div style={{ marginTop: "1.5rem" }}>
              ...
              >
                ...
                one album). An <strong>Album Series</strong> groups multiple
                packs together (e.g., all albums by an artist).
              </p>
            </div>
            ...
            <div style={{ marginTop: "1.5rem" }}>
              ...
              <p
                style={{ lineHeight: "1.6", color: "#555", marginLeft: "1rem" }}
              >
                Check off all your workflow steps on the WIP page. When all
                steps are complete, the song shows 100% completion and you'll
                see a celebration! 🎉
              </p>
            </div>
          ...
          <section style={{ marginBottom: "2.5rem" }}>
            ...
            <ul style={{ lineHeight: "1.8", color: "#555" }}>
              <li>
                Use meaningful workflow step names that match your actual
                process
              </li>
              <li>Create packs for albums to keep songs organized</li>
              <li>
                Add collaborators early so they can track their progress from
                the start
              </li>
              <li>
              ...
              <li>
                Check the Stats page regularly to see your overall progress
              </li>
            </ul>
          </section>
