...
export default function AlbumSeriesEditModal({
  ...
  // console.log("AlbumSeriesEditModal props:", {
  //   isOpen,
  //   packId,
  ...
  const reload = async () => {
    console.log("DEBUG: reload called with:", {
      createMode,
      seriesId,
      createData,
    });
  ...
  useEffect(() => {
    if (createMode && createData && canShow) {
      // console.log("Create mode data changed, reloading");
      reload();
    }
  ...
  // console.log("Rendering modal:", { isOpen, canShow, createMode });
